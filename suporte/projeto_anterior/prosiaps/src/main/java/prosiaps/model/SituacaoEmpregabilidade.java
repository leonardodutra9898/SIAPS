...
@Entity
@Table(name="tb_cadastro_situacao_mercado_trabalho")
public class SituacaoEmpregabilidade implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SituacaoEmpregabilidade other = (SituacaoEmpregabilidade) obj;
		if (id != other.id)
			return false;
		return true;
	}
