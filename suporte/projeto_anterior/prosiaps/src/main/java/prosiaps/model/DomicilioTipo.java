...
@Entity
@Table(name="tb_cadastro_domicilio_tipo")
public class DomicilioTipo implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DomicilioTipo other = (DomicilioTipo) obj;
		if (id != other.id)
			return false;
		return true;
	}
