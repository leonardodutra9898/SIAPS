...
@Entity
@Table(name="tb_cadastro_escoamento_sanitario")
public class EscoamentoSanitario implements Serializable {
	...
	@Column(name="forma_escoamento_banheiro_sanitario")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EscoamentoSanitario other = (EscoamentoSanitario) obj;
		if (id != other.id)
			return false;
		return true;
	}
